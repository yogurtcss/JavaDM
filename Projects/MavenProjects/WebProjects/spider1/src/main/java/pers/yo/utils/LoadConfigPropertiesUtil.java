...
public class LoadConfigPropertiesUtil {
    ...
    static{ // properties文件中都是一些静态的常量,所以把这块读取的代码写在静态代码块中 不是写在普通的方法
        ...
        InputStream is = LoadConfigPropertiesUtil.class.getClassLoader().getResourceAsStream( "config.properties" );
        try{
            props.load(is);
        }catch( IOException e ){
            e.printStackTrace();
    ...
    public static String getPropsFromConfigByKeyName( String keyName ){
    ...
    public static void main(String[] args) {
        System.out.println( LoadConfigPropertiesUtil.getPropsFromConfigByKeyName("threadNum") );
    }
}
